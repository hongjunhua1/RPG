    ...
    while (true) {
        ...
        if (action == DEATH && frame >= DEATH_FRAMES) {
            ...
            case WALK:
                ...
                // Special handling for missing up frames
                if (direction == UP && xFrame >= (WALK_FRAMES - 4) * WOLF_WIDTH) {
                    xFrame -= 4 * WOLF_WIDTH;
                }
                break;
            case RUN:
                ...
                // Special handling for missing up frames
                if (direction == UP && xFrame >= (RUN_FRAMES - 4) * WOLF_WIDTH) {
                    xFrame -= 4 * WOLF_WIDTH;
                }
                break;
            case BITE:
                ...
                // Special handling for missing up frames
                if (direction == UP && xFrame >= (BITE_FRAMES - 4) * WOLF_WIDTH) {
                    xFrame -= 4 * WOLF_WIDTH;
                }
                break;
            case HOWL:
                ...
                // Special handling for missing up frames
                if (direction == UP && xFrame >= (HOWL_FRAMES - 4) * WOLF_WIDTH) {
                    xFrame -= 4 * WOLF_WIDTH;
                }
                break;
            case DEATH:
                ...
                // Special handling for missing up frames
                if (direction == UP && xFrame >= (DEATH_FRAMES - 4) * WOLF_WIDTH) {
                    xFrame -= 4 * WOLF_WIDTH;
                }
                break;
            }
